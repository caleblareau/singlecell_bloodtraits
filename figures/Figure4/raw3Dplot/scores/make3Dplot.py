...
x, y, z, col = np.genfromtxt("dfs/" + sys.argv[1] + "/"+sys.argv[2]+".txt", unpack=True)

fig = plt.figure()
ax = fig.add_subplot(111,projection='3d')
line = ax.scatter(x, y*-1, z, c = col, s=5, edgecolors='none', depthshade=0,linewidth=0)
ax.view_init(27, -7)
...
plt.savefig("pdfs/" + sys.argv[1] + "/"+sys.argv[2]+ ".pdf", transparent=True)
