...
counts <- counts[,c("HSC", "MPP", "LMPP", "CLP", "CD4")]
...
lym_countsZ <- ATAC.cpm.log2.z[,c("HSC", "MPP", "LMPP", "CLP", "CD4")]

pdf(file="plots/lym_cluster_peaks.pdf", width = 3, height = 8)  
par(cex.main=0.8,mar=c(1,1,1,1))
Heatmap(lym_countsZ, col=as.character(jdb_palette("brewer_spectra",type="continuous")),
